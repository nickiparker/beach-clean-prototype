    ...
    _this.goToNext = function() {
        ...
        if (_this.options._mode === "horizontal") {
            ...
            _this.tweenObj.onComplete.add(function() {
                ...
                // enable prev
                if (_this.options._showHandles === true) {
                    this.sliderControlsGroup.children[1].alpha = 0.2;
                }
            }, _this);
        } else {
    ...
    _this.goToPrev = function() {
        ...
        if (_this.options._mode === "horizontal") {
            ...
            _this.tweenObj.onComplete.add(function() {
                ...
                // enable next
                if (_this.options._showHandles === true) {
                    this.sliderControlsGroup.children[0].alpha = 0.2;
                }
           ...
           // draggableSprite.input.enableSnap(_this.options._width, _this.options._height, true, true);
            ...
            if (_this.options._showHandles === true) {
                ...
                if (_this.options._customHandleNext === "") {
                    ...
                    chevronRight.scale.setTo(0.3, 0.3);
                    chevronRight.alpha = 0.2;
                } else {
                ...
                chevronRight.y = (_this.options._height / 1.7) - chevronRight.height / 2;
                ...
                if (_this.options._customHandlePrev === "") {
                    ...
                    chevronLeft.scale.setTo(0.3, 0.3);
                    chevronLeft.alpha = 0.2;
                } else {
                    chevronLeft = game.add.image(0, 0, _this.options._customHandlePrev);
                }
                chevronLeft.x = 10;
                chevronLeft.y = (_this.options._height / 1.7) - chevronLeft.height / 2;
